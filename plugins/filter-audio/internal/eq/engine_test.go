...
func TestComputeBiquadLowPassUnityGainAtDC(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EQConfig{Type: config.EQTypeLowPass, FrequencyHz: 1000, Q: 0.7071067811865476}, 48000)
...
func TestComputeBiquadHighPassZeroGainAtDC(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EQConfig{Type: config.EQTypeHighPass, FrequencyHz: 1000, Q: 0.7071067811865476}, 48000)
...
func TestComputeBiquadPeakingZeroGainIsAllPass(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EQConfig{Type: config.EQTypePeaking, FrequencyHz: 1000, GainDB: 0, Q: 0.7071067811865476}, 48000)
