...
> 実装進捗: **8 / 12 マイルストーン完了（M0〜M7）**。M6 の再完了は 2026-08-17、M7 の完了検証は 2026-08-22（M7-5 の stack review 反映まで）。
