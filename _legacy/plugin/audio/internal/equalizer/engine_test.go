...
func TestComputeBiquadLowPassUnityGainAtDC(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EqualizerTypeLowPass, 1000, 0, 0.7071067811865476, 48000)
...
func TestComputeBiquadHighPassZeroGainAtDC(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EqualizerTypeHighPass, 1000, 0, 0.7071067811865476, 48000)
...
func TestComputeBiquadPeakingZeroGainIsAllPass(t *testing.T) {
	t.Parallel()
	c := computeBiquad(config.EqualizerTypePeaking, 1000, 0, 0.7071067811865476, 48000)
